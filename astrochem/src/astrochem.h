...
#define GRAIN_GAS_MASS_RATIO_DEFAULT 0.01  /* Default grain mass ratio */
#define GRAIN_MASS_DENSITY_DEFAULT 1.81    /* Default grain mass density, Olivine grains, g/cm3  */
...
#define REL_ERR_DEFAULT 1e-06            /* Default relative error */
...
#define MIN_ABUNDANCE 1.e-40   /* Minimum abundance to write in output files */
#define MIN_ICE_ABUND 1.e-18           /* Minimum f val for desorption and hydrogenation */

#define FRACTION_TIME_GRAIN_70K 3.16e-19
#define GAS_DUST_NUMBER_RATIO 7.57e+11
#define GRAIN_SITES_PER_CM2 3.20e+15    /* cm-2 */
#define DRAINE_STANDARD_ISRF_FUV 1.e8  /* photons cm-2 */
